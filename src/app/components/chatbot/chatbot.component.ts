...
export class ChatbotComponent implements OnInit, OnDestroy {
  ...
  onSuggestedQuestionClick(question: string): void {
    ...
    this.conversationService.addMessage(question, 'user');
  ...
  onQuickSuggestionClick(suggestion: string): void {
    ...
    this.conversationService.addMessage(suggestion, 'user');
  ...
  // ============ NUEVO: MÉTODO PARA DEBUG DE STOP ============
  
  /**
   * Método para debug: mostrar qué se borraría al presionar STOP
   */
  debugStopInfo(): void {
    console.log('🔍 DEBUG - Información de STOP:');
    console.log('💾 Última pregunta cacheada:', this.lastUserQuestionForRestoration);
    console.log('📝 Mensajes actuales:', this.messages.length);
    console.log('🔄 isProcessing:', this.isProcessing);
    
    if (this.lastUserQuestionForRestoration) {
      console.log('🎯 La próxima acción STOP haría:');
      console.log('   Tipo:', this.lastUserQuestionForRestoration.type);
      console.log('   Restaurar al input:', this.lastUserQuestionForRestoration.type === 'user');
      console.log('   Contenido:', this.lastUserQuestionForRestoration.content.substring(0, 50));
    }
  }
}